      ...
      <section class="content">
        <div class="container-fluid">
          <div class="content-card">
            <h3><i class="fas fa-edit"></i> Form Edit Matriks</h3>
            <form action="/matriks/update/<?= $matrix['id_matriks'] ?>" method="post">
                ...
                <select name="kode_alternatif" id="kode_alternatif" class="form-control" required>
                  <?php foreach ($alternatif as $alt): ?>
                    <option value="<?= $alt['kode_alternatif'] ?>"
                      <?= ($matrix['kode_alternatif'] == $alt['kode_alternatif']) ? 'selected' : '' ?>>
              ...
              <div class="form-group">
                ...
                <select name="kode_kriteria" id="kode_kriteria" class="form-control" required>
                  <?php foreach ($kriteria as $kri): ?>
                    <option value="<?= $kri['kode_kriteria'] ?>" <?= ($matrix['kode_kriteria'] == $kri['kode_kriteria']) ? 'selected' : '' ?>>
              ...
              <div class="form-group">
                ...
                <input type="number" name="value" id="value" class="form-control" value="<?= $matrix['value'] ?>"
                  required>
              </div>
