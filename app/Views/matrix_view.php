...
<head>
  ...
  <title>Matriks Nilai Alternatif</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <div class="header">
        <h1>Matriks Nilai Alternatif</h1>
      </div>
      <section class="content">
        <div class="container-fluid">
          <div class="content-card">
            <h3><i class="fas fa-table"></i> Tabel Matriks Nilai Alternatif</h3>
            <table>
              <thead>
                <tr>
                  <th>ID Matriks</th>
              ...
              <tbody>
                <?php foreach ($matrix as $item): ?>
                  <tr>
                    <td><?= htmlspecialchars($item['id_matriks']) ?></td>
                    <td><?= htmlspecialchars($item['kode_alternatif']) ?></td>
                    <td><?= htmlspecialchars($item['kode_kriteria']) ?></td>
                    <td><?= htmlspecialchars($item['value']) ?></td>
                    <td>
                      <a href="/matriks/edit/<?= $item['id_matriks'] ?>" class="btn">Edit</a>
                      <a href="/matriks/delete/<?= $item['id_matriks'] ?>" class="btn"
            ...
            <div class="btn-container">
              <a href="/matriks/create" class="btn">Tambah Matriks</a>
            </div>
          </div>
        </div>
      </section>
